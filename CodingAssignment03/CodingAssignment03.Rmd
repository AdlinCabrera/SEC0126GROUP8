...
insurance_test$model_3_pred <- predict(model_1,newdata = insurance_test) %>% exp()
insurance_test$model_4_pred <- predict(model_2,newdata = insurance_test) %>% exp()

insurance_test$model_5_pred <- predict(model_1,newdata = insurance_test) %>% exp()
insurance_test$model_6_pred <- predict(model_2,newdata = insurance_test) %>% exp()

insurance_test$model_7_pred <- predict(model_1,newdata = insurance_test) %>% exp()
...
## model_5 <- lm(Charges  ~ LnAge + LnBMI + Female +Smoker  , data = insurance_train)

...
insurance_reduce$Childrensquared <- insurance_reduce$Children^2
...
model_1 <- lm( LnCharges ~., data = insurance_reduce[,c(5,6,3,4)] ) 
...
model_2 <- lm( LnCharges ~., data = insurance_reduce[,c(5,2,7,4)] ) 
...
model_3 <- lm( LnCharges ~., data = insurance_reduce[,c(5,2,3,8)] ) 
...
model_4 <- lm( Charges ~., data = insurance_reduce[,c(1,6,7,4)] ) 
...
model_5 <- lm( Charges ~., data = insurance_reduce[,c(1,2,7,8)] ) 
...
model_6 <- lm( Charges ~., data = insurance_reduce[,c(1,6,3,8)] ) 
...
model_7 <- lm( LnCharges ~., data = insurance_reduce[,c(5,2,3,8)] ) 
...
model_8 <- lm( LnCharges ~., data = insurance_reduce[,c(5,2,7,4)] ) 
...
insurance_reduce_female <- insurance_train[,c(1:4,5)]

model_female <- lm( Charges ~., data = insurance_reduce_female) 

summary(model_female)

insurance_reduce_smoker <- insurance_train[,c(1:3,5:6)]

model_smoker <- lm( Charges ~., data = insurance_reduce_smoker) 

summary(model_smoker)

insurance_reduce_smoker_female <- insurance_train[,c(1:6)]

model_smoker_female <- lm( Charges ~., data = insurance_reduce_smoker_female) 

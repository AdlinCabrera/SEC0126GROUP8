...
abline(v = mean(Health1$Charges),                       # Add line for mean
       col = "red",
       lwd = 3)
abline(v = median(Health1$Charges),                       # Add line for mean
       col = "orange",
       lwd = 3)
...
abline(v = mean(Health1$Age),                       # Add line for mean
       col = "red",
       lwd = 3)
abline(v = median(Health1$Age),                       # Add line for mean
       col = "orange",
       lwd = 3)
...
abline(v = mean(Health1$BMI),                       # Add line for mean
       col = "red",
       lwd = 3)
abline(v = median(Health1$BMI),                       # Add line for mean
       col = "orange",
       lwd = 3)
...
abline(v = mean(Health1$Children),                       # Add line for mean
       col = "red",
       lwd = 3)
abline(v = median(Health1$Children),                       # Add line for mean
       col = "orange",
       lwd = 3)

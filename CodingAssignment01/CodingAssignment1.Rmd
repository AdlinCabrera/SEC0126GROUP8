...
Based off the analysis we found the following… All histograms show that they skew to the right excluding the histogram of Age. The histogram of age shows more of a symmetric bell curve shape. All histograms show as unimodal distribution because of the one identified one mode or modal class in each histogram. Our variances and Standard deviation are shown below. We determined Variance by Sum of squared deviations of xi from divided by degrees of freedom. The Standard Deviation by Square root of variance. Gets parameter you are measuring into right units. The standard deviation measures how far a group of numbers is from the mean. The variance is the average of the squared differences from the mean.

**The Histogram of charges:**

* Skewed Right/ Positively Skewed because the mean is greater than the median
* Since the mean is not approximately equal to the median the distribution is not symmetric.
* Variance: 

**The Histogram of Age:**

* Bell-Shaped/ the mean is approximately equal to the median which means that the histogram is symmetric.
* This histogram is unimodal because the data has one single mode, identified by the ‘peak’ of the curve.

**The Histogram of BMI:**

* Skewed Right/ Positively Skewed. While the mean and median are relatively close the histogram is not symmetric. The mean is greater than the median.
* This histogram is unimodal because the histogram

**The Histogram of Children:**

* Skewed Right/ Positively Skewed. While the mean and median are relatively close the histogram is not symmetric. The mean is greater than the median.
* This histogram is unimodal as only once peak is identified.

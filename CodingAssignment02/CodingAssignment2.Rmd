...
newPrediction_Age <- insurance[2,]

predict(model_full, newdata= newPrediction_Age, interval = "confidence")

newPrediction_BMI <- insurance[3,]

predict(model_full, newdata= newPrediction_BMI, interval = "confidence")

newPrediction_Children <- insurance[4,]

predict(model_full, newdata= newPrediction_Children, interval = "confidence")

newPrediction_Gender <- insurance[5,]

predict(model_full, newdata= newPrediction_Gender, interval = "confidence")

newPrediction_Smoker <- insurance[6,]

predict(model_full, newdata= newPrediction_Smoker, interval = "confidence")

...
* **Answer**: BMI would be the significant variable in this two tailed test. It is the only variable that fits the two tailed test p < alpha. 
* Alpha = .2 
* BMI =.03. 
Thus .03 < .2.
...
The coefficient of the BMI independent variable was significant, this can provide indications that can affect the dependent variable varying on whether the coefficient of the BMI is positive or negative. A positive coefficient of the BMI provides evidence that as the value of the independent variable increases, the mean of the dependent variable tends to increase. A negative coefficient of the BMI provides evidence that as the value of the independent variable increases, the dependent tends to decrease. The coefficient provides us needed data that shows how much the mean of the dependent variable varies. 
...
```
The result indicates that the insurance representative can expect the value in medical expenses to be about 5,961.37 and that they can be 95 percent confident that the true value lies somewhere between 2,002.34 and 9,920.41.
